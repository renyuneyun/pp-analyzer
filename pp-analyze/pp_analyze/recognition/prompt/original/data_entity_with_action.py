...
Also do not output anything that is not the data entity list, such as explanations or comments. If there are no data entities in the segment, please return an empty list.
'''
